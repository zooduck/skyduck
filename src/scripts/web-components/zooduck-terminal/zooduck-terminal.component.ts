...
class HTMLZooduckTerminalMessageEmulator extends HTMLElement {
    ...
    constructor() {
        ...
        this._message = `
            Building software for Internet Explorer is like trying to fit a V8 engine to a pram.
            It's entirely possible, but completely ridiculous.
            This insanity needs to stop. Join the campaign to end browser misery for everyone, forever.
            It's high time the public know the truth about Microsoft.
        `.trim().replace(/\s\s/g, '');
